...
print("\(myVowel) is vowel? \(myVowel.isVowel())")
print("\(myConsonant) is vowel? \(myConsonant.isVowel())")
...
print("My Rectangle: \(myRectangle)")
print("My Smaller Rectangle: \(mySmallerRectangle)")
